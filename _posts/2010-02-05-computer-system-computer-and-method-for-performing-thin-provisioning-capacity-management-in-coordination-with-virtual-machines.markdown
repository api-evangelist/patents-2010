...
Using this identifier SVPOOL 1 the server level virtual volume capacities 30000 MB and 20000 MB in other words a total capacity of 50000 MB are specified from the information in .
