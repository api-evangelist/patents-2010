...
2 MAC MAC . . . MACN the nodes to reach the destination. MACN is the destination MAC1 is the node sending the AGROHello and the order of these MACs sets the order to follow towards the destination.

3 of explosive neighbours of MAC MAC . . . MACN number of explosive neighbours associated to every node of the path.
